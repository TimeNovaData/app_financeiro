...
class ContaNivel1Create(AcessoGeralView, CreateView):
    model = ContaNivel1
    ...
    def get_success_url(self):
        ...
        return reverse_lazy_plus(
            "conta_nivel1",
            get_params={
                "mensagem_toastify": "Conta gerencial nível 1 adicionada com sucesso!"
            },
            just_uri=True,
        )
    ...
    def get_context_data(self, **kwargs):
        ...
        context["title"] = "Nova conta gerencial nível 1"
    ...
    def get_breadcrumb(self):
        ...
        nova_conta_nivel1 = {
            "name": "Nova conta gerencial nível 1",
            "slug": "nova_conta_nivel1",
            "url_name": "",
        }

        return make_breadcrumb(
            [financeiro, cadastros, grupo_conta, nova_conta_nivel1]
        )
