...
class ContaNivel2Create(AcessoGeralView, CreateView):
    model = ContaNivel2
    ...
    def get_success_url(self):
        ...
        return reverse_lazy_plus(
            "conta_nivel2",
            get_params={
                "mensagem_toastify": "Conta gerencial nível 2 adicionada com sucesso!"
            },
            just_uri=True,
        )
    ...
    def get_context_data(self, **kwargs):
        ...
        context["title"] = "Nova conta gerencial nível 2"
    ...
    def get_breadcrumb(self):
        ...
        nova_conta_nivel2 = {
            "name": "Nova conta gerencial nível 2",
            "slug": "nova_conta_nivel2",
            "url_name": "",
        }

        return make_breadcrumb(
            [financeiro, cadastros, grupo_conta, nova_conta_nivel2]
        )
